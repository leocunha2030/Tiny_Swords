...
func _ready() -> void:
	...
	#h lth = transition_screen.player_health #Deletar Linha se não quiser manter a vida para a proxima fase
		return
...
#Cria a função que le as teclas das setas para mover
#o personagem 
#O normalized é necessario
